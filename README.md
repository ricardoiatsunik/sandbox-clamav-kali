...
Objetivo: Criação de um ambiente sandbox offline utilizando o Kali Linux em uma máquina virtual no VirtualBox, com foco em análise estática de arquivos suspeitos usando o antivírus ClamAV. Com prioridade em garantir segurança e isolamento durante a análise.
...
- VirtualBox
- Snapshots e clones
- FreshClam (o Clam deve estar sempre atualizado!)
